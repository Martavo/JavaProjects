...
public class M8_Exercici6 {
		...
		do{
		      ...
		      switch(opcion){
		         ...
		         case 1:
		            ...
		            break;
		         case 2: 
		        	 mostrarTrabajador(listEscuderias);
		            break;
		         case 3:
		        	 trabajador = buscarTrabajador(listEscuderias);
	...
	public static void mostrarTrabajador(ArrayList<Escuderia>listEscuderias) {
		int i =0;
	    ...
	    for (Escuderia escuderia : listEscuderias) {
	        for (Trabajadores trabajador : escuderia.getListTrabajadores()) {
	            if (trabajador.getNombre().equalsIgnoreCase(nombreTrabajador)) {
	                ...
	                System.out.println("Tiempo trabajado: " + trabajador.getTiempoTrabajado());
	                System.out.println("Sueldo: " + trabajador.Sueldo());

	                // Verificar si el trabajador es un mecánico o un piloto
	                if (trabajador instanceof Mecanicos) {
	                    Mecanicos mecanico = (Mecanicos) trabajador;
	                    System.out.println("Es un mecánico");
	                    System.out.println("Tiene estudios superiores de mecánica: " + mecanico.isEstudiosMecanica());
	                } else if (trabajador instanceof Pilotos) {
	                    Pilotos piloto = (Pilotos) trabajador;
	                    System.out.println("Es un piloto");
	    ...
	    if (!trabajadorEncontrado) {
	        System.out.println("El trabajador llamado " + nombreTrabajador + " no existe en el sistema");
	    }
	}
}
